...
resource "aws_iam_role" "dataworks_aws_collections_rehydration_emr_service" {
  name               = "dataworks_aws_collections_rehydration_emr_service"
...
#   role       = aws_iam_role.dataworks_aws_collections_rehydration_emr_service.name
...
resource "aws_iam_policy" "emr_capacity_reservations" {
  name        = "dataworks_aws_collections_rehydrationCapacityReservations"
...
resource "aws_iam_role_policy_attachment" "dataworks_aws_collections_rehydration_emr_service_ebs_cmk" {
  role       = aws_iam_role.dataworks_aws_collections_rehydration_emr_service.name
