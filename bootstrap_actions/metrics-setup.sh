...
(
    ...
    function log_wrapper_message() {
        log_dataworks_aws_collections_rehydration_message "$1" "metrics-setup.sh" "$$" "Running as: $USER"
    }
...
) >> /var/log/dataworks-aws-collections-rehydration/metrics-setup.log 2>&1
